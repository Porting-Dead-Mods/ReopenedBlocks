package com.portingdeadmods.reopenedblocks.networking;

import com.portingdeadmods.reopenedblocks.ReopenedBlocks;
import com.portingdeadmods.reopenedblocks.networking.bidirectional.ExampleBidirectionalPayload;
import com.portingdeadmods.reopenedblocks.networking.clientbound.ExampleClientboundPayload;
import com.portingdeadmods.reopenedblocks.networking.serverbound.ExampleServerboundPayload;
...
public class NetworkEvents {
    ...
    public static void registerPayloads(final RegisterPayloadHandlersEvent event) {
        final PayloadRegistrar registrar = event.registrar(ReopenedBlocks.MODID);
